...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="bg-card w-full max-w-sm border border-border rounded-lg shadow-sm p-6 relative">
        ...
        {step === 1 && (
          <form onSubmit={handleFamilySubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 px-4 bg-primary text-primary-foreground font-medium rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 transition-colors"
            >
        ...
        {step === 2 && (
          <div className="space-y-3">
              ...
              <div className="space-y-2 mb-4">
                {usersList.map((user) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 p-3 border border-border rounded-md hover:bg-muted transition-colors text-left"
                  >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 px-4 border border-dashed border-primary text-primary font-medium rounded-md hover:bg-primary/5 transition-colors"
            >
